...
- [ ] Integrate `ipinfo.io` API to detect visitor country on page load (free tier: 50k lookups/month)
- [ ] Automatically display UK or international phone number based on detected country
- [ ] Add manual toggle near contact details — "Switch to UK / International number" — for VPN/abroad users
